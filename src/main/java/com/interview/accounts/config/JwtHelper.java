...
import com.interview.accounts.service.TokenBlacklistService;
...
public class JwtHelper {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        logger.info("isTokenBlackList:"+isBlacklisted);
        final String username = getUsernameFromToken(token);
        return (!isBlacklisted && username.equals(userDetails.getUsername()) && !isTokenExpired(token));
    }
